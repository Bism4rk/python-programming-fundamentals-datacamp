...
'''
O código acima demonstra como usar conjuntos em Python para encontrar a diferença entre dois conjuntos de espécies de pinguins. Ele cria uma lista de espécies femininas a partir de uma lista de dicionários, converte essa lista em um conjunto e, em seguida, calcula a diferença entre o conjunto de espécies femininas e o conjunto de espécies masculinas. O resultado é impresso, mostrando quais espécies são exclusivas do conjunto feminino.
'''