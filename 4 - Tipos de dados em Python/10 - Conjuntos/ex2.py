from ex1 import penguins, male_penguin_species
...
'''
O código acima demonstra como usar operações de conjuntos em Python. Ele cria um conjunto de espécies de pinguins fêmeas, calcula a diferença entre as espécies fêmeas e masculinas, e imprime as espécies que estão apenas no conjunto feminino.
'''